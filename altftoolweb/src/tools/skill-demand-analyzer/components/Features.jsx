...
const Features = () => {
  ...
  const features = [
    {
      title: "Accurate Skill Demand Analysis",
      description:
        "Calculate the exact demand for your skills based on market trends and job postings.",
    },
    {
      title: "Instant Results",
      description:
        "Get your skill demand analyzed immediately with real-time processing. No delays, just quick and accurate output.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Minimal, distraction-free design that makes calculating your skill demand easy and user-friendly.",
    },
    {
    ...
    <section className="py-8 sm:py-10 px-4 bg-(--background) transition-colors duration-300">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          >
            Why Choose Our Skill Demand Analyzer?
          </motion.h2>
          <motion.p
            className="text-base sm:text-lg text-(--muted-foreground) max-w-2xl mx-auto leading-relaxed"
            variants={headerVariants}
          >
            Simple, fast, and accurate skill demand analysis for everyone
          </motion.p>
        </motion.div>
