...
export default function VideoFilters({
  ...
  const hasFilters = search || category || videoFilter;
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3 flex flex-wrap items-center gap-3 mb-5">
