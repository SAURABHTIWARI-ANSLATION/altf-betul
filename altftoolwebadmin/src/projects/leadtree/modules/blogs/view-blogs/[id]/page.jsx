      ...
      <div className="max-w-6xl mx-auto px-5 py-7">
        ...
        <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => router.push(`/leadtree/blogs/edit-blog/${blog.id}`)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            {(blog.likesCount !== undefined || blog.commentsCount !== undefined) && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                <h3 className="text-xs font-black text-gray-400 uppercase tracking-widest mb-3">Engagement</h3>
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-xl p-3 text-center">
                    <p className="text-2xl font-bold text-gray-800 tabular-nums">{blog.likesCount ?? 0}</p>
                    <p className="text-[10px] font-bold text-gray-400 uppercase mt-0.5">Likes</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-3 text-center">
                    <p className="text-2xl font-bold text-gray-800 tabular-nums">{blog.commentsCount ?? 0}</p>
                    <p className="text-[10px] font-bold text-gray-400 uppercase mt-0.5">Comments</p>
                  </div>
                </div>
              </div>
            )}
