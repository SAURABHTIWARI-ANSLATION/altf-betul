...
import {
  ...
  updateBlogImage,
  uploadBlogImage,
} from "../lead-blog-services/BlogPostService";
import { serverTimestamp } from "firebase/firestore";
import CategorySelector from "../components/LeadTreeCateogrySelectore";
...
const BlogEditor = dynamic(() => import("../components/LeadTreeBlogEditor"), { ssr: false });
    ...
    try {
      ...
      try {
        blogRef = await createBlog({
          ...
          views: 0, status: "published", readTime: readTime,
        });
      } catch (err) {
      ...
      logAuditEvent({
        ...
        route: "/leadtree/blogs/add-blogs",
      });
      ...
      setTimeout(() => router.push("/leadtree/blogs"), 500);
      ...
      <div className=" mx-auto px-5 py-7 space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            <button onClick={() => router.push("/leadtree/blogs")} className="p-2 rounded-xl border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 transition">
              ...
              <Section title="Content">
                ...
                <BlogEditor
                  ...
                  onChange={(data) => {
                    ...
                    const time = calculateReadTime(data);   
                    setReadTime(time);                      

                    setFormData((prev) => {
                      const updated = { ...prev, description: data };

                      if (!seoEdited.description) {
                        updated.seoDescription = generateExcerpt(data);
                      }
