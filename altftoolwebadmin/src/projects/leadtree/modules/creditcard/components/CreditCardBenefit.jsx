...
import { fetchBenefitedCardNames } from "../credit-card-services/CreditCardService";

export default function CreditCardBenefit({ value, onChange }) {
  ...
  useEffect(() => {
    (async () => {
      try {
          const snap = await fetchBenefitedCardNames();
  ...
  return (
    <div ref={wrapperRef} className="relative">
      <input
        ...
        placeholder="Select Card Benefit"
        onFocus={() => {
          setSearch("");
          setOpen(true);
        }}
